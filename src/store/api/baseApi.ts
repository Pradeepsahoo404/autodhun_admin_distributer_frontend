...
export const baseApi = createApi({
  ...
  tagTypes: ['Auth', 'Users', 'Roles', 'Modules', 'Permissions', 'Sidebar', 'Notifications', 'CronjobSettings', 'ReferenceOverlaps', 'InvalidReferences', 'OwnershipTransfers', 'PotentialClaims', 'DisputedClaims', 'AppealedClaims', 'YoutubeClaimReleases', 'FacebookClaimReleases', 'ContentIds', 'Oac', 'ProfileLinking', 'Allowlist', 'ManualClaiming', 'Takedown', 'MusicReleases', 'ReleaseCatalog', 'LabelTransfer'],
  endpoints: () => ({}),
});
