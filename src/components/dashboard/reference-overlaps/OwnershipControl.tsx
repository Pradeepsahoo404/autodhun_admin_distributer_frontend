...
import { getReferenceOverlapOwnershipLabel } from '@/constants/referenceOverlap';
...
export function OwnershipControl({ value, disabled, loading, onChange }: OwnershipControlProps) {
  if (disabled && value) {
    return (
      <span
        className={cn(
      ...
      >
        {getReferenceOverlapOwnershipLabel(value)}
      </span>
    );
  }
